...
mlflow.set_tracking_uri("http://localhost:5000")   # MLflow server started by the GitHub Actions job
...
with mlflow.start_run():
    ...
    classification_threshold = 0.45    # Slightly below 0.5 to favour recall on the minority (purchase) class; matches app.py
    ...
    model_path = "tourism_project/deployment/tourism_xgb_model.joblib"   # saved next to app.py
